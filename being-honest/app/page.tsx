      ...
      <section className="hero" id="top" role="banner" aria-label="being honest — Slow is our superpower">
        ...
        <div className="hero-content">
          ...
          <div className="cta">
            ...
            <a href="#why" className="btn ghost">Explore why slow</a>
          </div>
          </div>
      </section>
          ...
          <div className="links">
            ...
            <div className="contact-block" aria-label="Contact">
              ...
              <div className="contact-row">
                <a className="phone" href="tel:+919966399547" aria-label="Call +91 99663 99547">+91 99663 99547</a>
                <div className="contact-icons">
                  
                  <a className="icon" title="WhatsApp" aria-label="Open WhatsApp chat" href="https://wa.me/919966399547" target="_blank" rel="noopener">
                  ...
                  <a className="icon" title="Instagram" aria-label="Open Instagram profile" href="https://www.instagram.com/beinghonest.life/" target="_blank" rel="noopener">
                    <svg viewBox="0 0 24 24" width="22" height="22" fill="currentColor" aria-hidden>
